<template>
    <div :class="cardClasses" class="rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
      <div class="flex items-center justify-between">
        <div class="flex-1">
          <p class="text-sm font-medium opacity-80 mb-1">{{ message }}</p>
          <p class="text-4xl font-bold">{{ formattedValue }}</p>
        </div>
